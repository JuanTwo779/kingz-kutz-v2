  ...
  <div className='app__bg_2 app__wrapper section__padding' id='contact'>
    ...
    <div className="app__wrapper_info">
      ...
      <div className='app__wrapper-content'>
        ...
        <p className='p__opensans' style={{color: 'var(--color-white)'}}>Mon-Fri: 9:00am - 6:00pm</p>
        <p className='p__opensans' style={{color: 'var(--color-white)'}}>Weekends: 10:00am - 5:00pm</p>
      </div>
    </div>
